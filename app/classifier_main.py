...
from classifierFuncs.algoConfig import batchAlgs, GS_top2, GS_SGD, saveModel, ngramModel
from sklearn.linear_model import LogisticRegression,SGDClassifier


#fetch requires the number of rows in the review database 
train_set, test_set = fetch(100000, 10)
...
# GS_top2(X_train, y_train, X_test, y_test)      # batchAlgs() identified LogReg and SVC performed best, run #2
# GS_SGD(X_train, y_train, X_test, y_test)        # Using SGDClassifier, run #3
ngramModel(text_train, y_train)
